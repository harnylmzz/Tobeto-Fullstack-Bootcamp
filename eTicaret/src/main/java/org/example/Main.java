...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Kullanıcı: " + user1.getName() + user1.getLastName() + " - Kategori: " + category1.getName() + " - Ürün: " + product1.getName() + " - Sipariş adedi: "  + order1.getQuantity() + " - Sipariş notu: " + order1.getOrderNotes());
